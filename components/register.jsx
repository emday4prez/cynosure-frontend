    ...
    <div className="flex w-full flex-col">
      ...
      <div className="w-full bg-white border-2 rounded p-8 m-4 md:max-w-sm md:mx-auto">
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter mb-4">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-sky-900 py-2">
            Register
          </span>
        </h1>
        <form
        ...
        >
          ...
          <button
            className="block bg-blue-600 text-white text-lg rounded p-4 mx-auto"
            type="submit"
          >
            Register
          </button>
